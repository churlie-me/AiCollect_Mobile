            ...
            try
            {
                ...
                groupRadioButton.SelectedItemChanged += (sender, args) =>
                {
                    try
                    {
                        ...
                        {
                            if (question.Conditions.FirstOrDefault().DataCollectionObectType == DataCollectionObectTypes.SubSection)
                            {
            ...
            try
            {
                ...
                label.PropertyChanged += (sender, e) =>
                {
                    if (e.PropertyName == "Text" && !string.IsNullOrEmpty((sender as Label).Text))
                    {
                        ...
                        if (qn != null && question.Conditions.Count > 0)
                        {
                            if (qn.Conditions.FirstOrDefault().DataCollectionObectType == DataCollectionObectTypes.Question)
                            {
