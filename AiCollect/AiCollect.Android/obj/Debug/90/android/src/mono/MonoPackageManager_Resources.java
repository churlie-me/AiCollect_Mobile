...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "AiCollect.Android.dll" comes first in this list. */
		"AiCollect.Android.dll",
		"AiCollect.dll",
		"FormsViewGroup.dll",
		"GeoJSON.Net.dll",
		"GoogleGson.dll",
		...
		"Naxam.MapboxAccounts.Droid.dll",
		"Naxam.MapboxAnnotation.Droid.dll",
		"Naxam.MapboxBuilding.Droid.dll",
		"Naxam.MapboxGestures.Droid.dll",
		"Naxam.MapboxSdkGeojson.Droid.dll",
		"Naxam.MapboxSdkTurf.Droid.dll",
		"Naxam.MapboxTraffic.Droid.dll",
		"Naxam.SoLoader.Droid.dll",
		"Newtonsoft.Json.dll",
